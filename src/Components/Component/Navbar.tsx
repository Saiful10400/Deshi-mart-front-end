...
const Navbar = () => {
  ...
  return (
    <div className="mt-5 lg:px-0 px-4 pt-3">
    <div className="flex  lg:flex-row  items-center justify-between  gap-8 pb-5 lg:pb-0 lg:gap-0 left-0">
      ...
      <div className="flex items-center w-[60%] justify-between ">
        ...
        <form
          ...
          className="relative lg:flex w-[70%] hidden  justify-end"
        >
          <input
